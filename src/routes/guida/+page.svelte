...
<div class="guide">
	...
	<section class="g-card">
		...
		<p>Nelle schede trovi anche: <strong>Usi</strong> (parole con più ruoli), <strong>📝 note personali</strong>, e <strong>✏️ Correggi</strong> se un dato è sbagliato. Quando presenti, sono collegate direttamente: <strong>sinonimi</strong>, <strong>contrari</strong>, <strong>omofoni</strong> (stessa lettura), il <strong>verbo transitivo/intransitivo corrispondente</strong> (es. 開く↔開ける), e il <strong>keigo</strong> (尊敬語/謙譲語) quando il verbo ne ha uno — la copertura di questi collegamenti cresce nel tempo, non tutte le parole li hanno ancora.</p>
	</section>
