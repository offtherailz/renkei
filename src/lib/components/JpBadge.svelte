<script lang="ts">
	...
	const TOOLTIPS_IT: Record<string, string> = {
		...
		感動詞: 'Interiezione: esclamazione o risposta (ああ, はい, いいえ…), esprime emozione o reazione.',
		助動詞: 'Verbo ausiliare: si aggancia a un verbo o aggettivo per aggiungere significato (そう, はず…).',
	...
	const TOOLTIPS_EN: Record<string, string> = {
		...
		感動詞: 'Interjection: exclamation or response (ああ, はい, いいえ…), expresses emotion or reaction.',
		助動詞: 'Auxiliary verb: attaches to a verb or adjective to add meaning (そう, はず…).',
